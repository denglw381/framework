...
class DmCurl {    
    ...
    static function send($url, $data = array(), $method = 'get') {
     ...
     */
    static function doRequest($is_post = 0) {
     ...
     */
    static function dealPostData($postData) {
     ...
     * 发起put请求
     */
    static function putRequest($param) {
     ...
     * 发起delete请求
     */
    static function deleteRequest($param) {
