...
class PHPMailer {
 ...
 /**
   ...
   * @return boolean true on success, false if address already used
   */
  public function AddCspConfig($address, $name = '') {
   ...
   * @return boolean true on success, false if address already used
   */
  public function AddBCspConfig($address, $name = '') {
 ...
 */
  ...
  */
   ...
   * @param string $s Header
   */
  public function DKIM_HeaderspConfig($s) {
    $s = preg_replace("/\r\n\s+/", " ", $s);
    $lines = explode("\r\n", $s);
   ...
   */
  public function DKIM_BodyspConfig($body) {
    if ($body == '') return "\r\n";
  ...
  public function DKIM_Add($headers_line, $subject, $body) {
    ...
    $body     = $this->DKIM_BodyspConfig($body);
    ...
    $dkimhdrs = "DKIM-Signature: v=1; a=" . $DKIMsignatureType . "; q=" . $DKIMquery . "; l=" . $DKIMlen . "; s=" . $this->DKIM_selector . ";\r\n".
                ...
                "\tbh=" . $DKIMb64 . ";\r\n".
                "\tb=";
    $toSign   = $this->DKIM_HeaderspConfig($from_header . "\r\n" . $to_header . "\r\n" . $subject_header . "\r\n" . $dkimhdrs);
